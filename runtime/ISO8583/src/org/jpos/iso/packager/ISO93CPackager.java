 ...
 * @see ISOComponent
 */
public class ISO93CPackager extends ISOBasePackager {
    ...
    /*019*/ new IFA_NUMERIC (  4, "Country code, Acquiring institution"),
    ...
    /*024*/ new IFA_NUMERIC (  4, "Function code"),
    ...
    /*030*/ new IFA_NUMERIC ( 12, "Amounts, original"),
    ...
    /*039*/ new IFA_NUMERIC (  4, "Action code"),
    ...
    /*049*/ new IFA_NUMERIC (  4, "Currency code, Transaction"),
    /*050*/ new IFA_NUMERIC (  4, "Currency code, Reconciliation"),
    /*051*/ new IFA_NUMERIC (  4, "Currency code, Cardholder billing"),
    /*052*/ new IFA_BINARY  (  8, "Personal identification number (PIN) data"),
    /*053*/ new IFA_LLNUM( 48, "Security related control information"),
    ...
    /*104*/ new IFA_LLCHAR (99, "Transaction description"),
