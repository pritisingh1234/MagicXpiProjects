...
/////Pack_Custom/    
	...
	public int unpack (ISOComponent m, byte[] b) throws ISOException {
    	System.out.println("Rev Inside Actual Unpack Function in BasePackager");
        ...
        try {
            ...
            if (m instanceof ISOMsg /*&& ((ISOMsg) m).getHeader()==null*/ && headerLength>0) 
            {
            	...
            	System.out.println("Recv Printing Consumed variable length" + consumed);
            }       
            
            if (!(fld[0] == null) && !(fld[0] instanceof ISOBitMapPackager))
            {
            	System.out.println("Recv Getting MTI message");
                ISOComponent mti = fld[0].createComponent(0);
                System.out.println("Recv Calling unpack for mti");
