...
public class NACChannel extends BaseChannel {
    ...
    int lenlen = 0;
	/*private static  ISO93BPackager pack = new ISO93BPackager();
	private static  String IP="10.50.8.141";
	private static  int port=58550;
    ...
    public static NACChannel getNACChannelInstance(){  
          if (obj == null)
          {
        	  Custom_Logs.WriteLogs("Object is null hence creating an object");
               obj = new NACChannel(IP,port,pack);//instance will be created at request time
               Custom_Logs.WriteLogs("New Object created with hash"+obj.hashCode());
          }else{
        	  Custom_Logs.WriteLogs("Returning same Object created with hash"+obj.hashCode());
          }
          return obj;
    }*/
    public NACChannel () {
     ...
     * @see ISOPackager
     */
    /*private NACChannel (String host, int port, ISOPackager p) {
        super(host, port, p);
        //this.header = TPDU;
    }*/
